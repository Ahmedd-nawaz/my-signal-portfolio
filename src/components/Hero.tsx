...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center text-center gap-lg px-md pt-16 bg-dark-bg overflow-hidden">
      {/* Background 3D Particles */}
      {!prefersReducedMotion && (
        <div className="absolute inset-0 pointer-events-none">
          <HeroScene key={isMobile ? "mobile" : "desktop"} isMobile={isMobile} />
        </div>
      )}
      {/* Hero Content */}
      <div className="relative z-10 flex flex-col items-center justify-center gap-lg">
        <FadeIn>
      ...
      {/* Scroll Indicator */}
      <div className="absolute bottom-2xl z-10 flex flex-col items-center gap-xs text-dark-text-muted/50">
